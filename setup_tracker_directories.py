...
if __name__ == "__main__":
    ...
    make_deepsort_directory('/home/flo/Videos/Video2.mp4',
                            ...
                            '/home/flo/Workspace/OtherTrackers/deep_sort/BA/train/BA-02/'
                            )
    """
    cvatdoc = CVATDocument('/home/flo/PycharmProjects/ba-evaluation/data/cvatgt/Video2.xml')
    cvatdoc.parse()
    # cvatdoc.MOT_to_CVAT_parsetree("./data/mot_fmt_results/panorama_tracker_TS_10_5.txt")
    setup_smot_tracker(cvatdoc, '/home/flo/Videos/Video2.mp4', '/home/flo/Workspace/OtherTrackers/smot/smot_data/',
